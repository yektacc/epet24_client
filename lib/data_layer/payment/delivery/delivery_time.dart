                        ...
                        children: <Widget>[
                          ...
                          new Expanded(
                            child: DropdownButton<int>(
                              ...
                              iconSize: 24,
                              elevation: 16,
                              style: TextStyle(color: StaticAppColors.grey),
                            ...
                            child: new StreamBuilder<int>(
                                ...
                                builder: (context, hourFromSnp) {
                                  ...
                                  return DropdownButton<int>(
                                    ...
                                    elevation: 16,
                                    style:
                                    TextStyle(color: StaticAppColors.grey),
...
class DeliveryDayItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Card(
      color: isSelected ? StaticAppColors.main_color : Colors.grey[50],
      child: Container(
...
class GotoPaymentBottomBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      height: 56,
      color: enabled ? StaticAppColors.main_color : Colors.grey[100],
      child: Row(
        children: <Widget>[
          Expanded(
            flex: 6,
          ...
          Expanded(
            ...
            child: Align(
              ...
              child: Text(
                "پرداخت",
                style: TextStyle(
                    color: enabled ? Colors.white : StaticAppColors.main_color,
                    fontSize: 14),
              ),
            ),
          ),
