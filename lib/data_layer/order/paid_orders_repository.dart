...
class OrdersRepository {
  ...
  Future<List<UserPaidOrder>> getUserOrders(String sessionId) async {
    PostResponse response = await _net.post(EndPoint.GET_PAID_ORDERS,
        body: {'seller_id': '6'}, cacheEnabled: false);
  ...
  Future<bool> checkOrderProductDelivery(OrderProductInfo product) async {
    var res = await _net.post(EndPoint.CHECK_PACKING,
        cacheEnabled: false,
        body: {
  ...
  Future<OrderSentInfo> getOrderSendingInfo(int orderId, int sellerId) async {
    var res = await _net.post(EndPoint.GET_TRANSACTION,
        cacheEnabled: false,
        body: {
          'order_id': orderId.toString(),
          'seller_id': sellerId.toString()
  ...
  Future<bool> submitReturnProduct(OrderProductInfo product, String sessionId,
    ...
    var res = await _net
        .post(EndPoint.SUBMIT_PRODUCT_RETURN, cacheEnabled: false, body: {
