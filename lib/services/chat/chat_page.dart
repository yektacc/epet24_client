...
class _ChatPageState extends State<ChatPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: CustomAppBar(
        titleText: widget._bloc.chat.otherTitle,
      ),
      body: Container(
              ...
              child: BlocBuilder<ChatBloc, ChatState>(
                ...
                builder: (context, state) {
                  if (state is MessagesLoaded) {
                    ...
                    widget._bloc.dispatch(SeenMessages(state.chat));


                    return _buildMessageList();
                  } else if (loadedMessages != null) {
                    if (state is FailedLoadingMessages) {
...
//    _scrollController.animateTo(0.0, duration: Duration(milliseconds: 200),curve: );
  ...
  void didChangeDependencies() {
    ...
    widget._bloc.dispatch(UpdateMessages());
  }
