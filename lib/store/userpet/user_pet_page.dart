  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      floatingActionButton: FloatingActionButton(
        backgroundColor: StaticAppColors.main_color,
        onPressed: () {
          ...
          if (snapshot.data != null) {
            return Container(
              child: TextFormField(
                ...
                cursorColor: StaticAppColors.main_color,
                decoration: InputDecoration(
                    counterText: '',
                    labelText: "سن حیوان",
                    border: UnderlineInputBorder(
                        borderSide: BorderSide(color: StaticAppColors.main_color))),
              ),
            );
          } else {
            return Container();
          ...
          if (snapshot.data != null) {
            return Container(
              child: RadioButtonGroup(
                activeColor: StaticAppColors.main_color,
  ...
  Widget _buildPetItem(int index, bool selected) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
          ...
          border: Border.all(
              color: selected ? StaticAppColors.main_color : Colors.red[50])),
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: Text(
              name,
              style: TextStyle(
                  color: StaticAppColors.second_color, fontWeight: FontWeight.bold),
            ),
          )
        ],
      ),
