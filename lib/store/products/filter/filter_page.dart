    ...
    return GestureDetector(
      ...
      child: Container(
          ...
          decoration: BoxDecoration(
              ...
              border:
              selected ? Border.all(color: StaticAppColors.main_color) : null),
          child: Row(
            children: <Widget>[
              Container(
                child: Icon(
                  Icons.done,
                  size: 19,
                  color: selected ? StaticAppColors.main_color : Colors.grey[400],
                ),
                ...
                child: Container(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(
                        fontSize: 11,
                        color:
                            selected ? StaticAppColors.main_color : Colors.grey[600]),
                  ),
                ),
              ),
            ],
                      ...
                      onPressed: () {
                        _filteredProductsBloc.dispatch(UpdateFilter(FilterData(
                            ...
                            minPrice: selectedRange.stream.value != null
                                ? Price(
                                    selectedRange.stream.value.start.toInt())
                                : null,
                            maxPrice: selectedRange.stream.value != null
                                ? Price(
                                selectedRange.stream.value.end.toInt())
                                : null,
