  ...
  Future<PostResponse> post(EndPoint endPoint,
    ...
    if (cacheEnabled && _cache.containsKey(initRequest.toString())) {
      ...
      if (endPoint == EndPoint.START_CHAT ||
          ...
          endPoint == EndPoint.GET_UNASSIGNED_BROADCAST_CHATS ||
          endPoint == EndPoint.SEEN_CHAT ||
          endPoint == EndPoint.GET_CHAT_BY_ID) {
...
//        print('dio error: headers: ${e.response.headers}');
        print(
            "\n!!!!!!!!!!!!!!!!!!!!!!!$endPoint!!!!!!!!!!!!!!!!!!!!!!!\n"
                "ERROR IN: $url $body \n"
                "------------------------------\n"
//                "response headers: ${e.response.headers?? "headers is null"}\n"
                "message: ${e.message} \n "
                "error: ${e.error}\n"
                "response:  ${e.response} \n"
                "!!!!!!!!!!!!!!!!!!!!!!!!!$endPoint!!!!!!!!!!!!!!!!!!!!!!!!!\n");
        ...
        if (e.response.statusCode == 429) {
          nextRetryAfter = int.parse(e.response.headers['retry-after'].first,
              onError: (_) => 0);
          print('retry after:  ${e.response.realUri}:' +
...
//  GET_ALL_CENTER_CHATS,
  GET_ALL_CENTER_CHATS,
  GET_UNASSIGNED_BROADCAST_CHATS,
  GET_ALL_USER_CHATS,
  GET_CHAT_BY_ID,
  SEEN_CHAT,
  GET_CONTACT_INFO,
...
String getSubUrl(EndPoint endPoint) {
  ...
  switch (endPoint) {
    ...
    case EndPoint.GET_ALL_CENTER_CHATS:
      subUrl = 'getsrvcenterunseenlist';
      break;
    case EndPoint.SEEN_CHAT:
      subUrl = 'setseen';
      break;
    case EndPoint.GET_CHAT_BY_ID:
      subUrl = 'getchatidchats';
      break;
    ...
    case EndPoint.GET_RETURN_REQUESTS:
      subUrl = 'getorder';
      break;
    case EndPoint.GET_UNASSIGNED_BROADCAST_CHATS:
      subUrl = 'getnullsrvcenterinchat';
      break;
    case EndPoint.BUG_REPORT:
      subUrl = 'bugreport';
      break;
  }
  return subUrl;
