              ...
              Expanded(
                  child: Container(
                      ...
                      child: _getCountInCart() == 0
                        ...
                        style: TextStyle(
                            fontSize: 22,
                            color: StaticAppColors.second_color,
                            fontWeight: FontWeight.bold),
                      ))),
            ],
          ),
              ...
              children: <Widget>[
                cartCount != 0
                  ...
                  decoration: BoxDecoration(
                      ...
                      color: light ? Colors.white : StaticAppColors.main_color),
                  child: Text(
                    cartCount.toString(),
                    style: TextStyle(
                        color:
                        light ? StaticAppColors.main_color : Colors.white,
                        fontWeight: FontWeight.bold,
                        fontSize: 11.5),
                  ),
                ...
                Icon(
                  Icons.shopping_cart,
                  color: light ? Colors.white : StaticAppColors.grey,
                )
              ],
            ),
          ),
