...
class _CenterDetailPageState extends State<CenterDetailPage> {
    ...
    return Scaffold(
      appBar: CustomAppBar(
        ...
        title: Text(
          ...
          style: TextStyle(fontSize: 16, color: StaticAppColors.main_color),
        ),
      ),
      body: Container(
        child: ListView(
                      ...
                      children: <Widget>[
                        GestureDetector(
                          child: Container(
                            ...
                            child: Container(
                              ...
                              child: AppIcons.showOnMap(StaticAppColors.main_color),
                            ),
                          ),
                          onTap: () {
                            showDialog(
                        ...
                        Expanded(
                          child: Align(
                            ...
                            child: Text(
                              "${widget.center.address}",
                              style: TextStyle(color: StaticAppColors.main_color),
                            ),
                          ),
                        )
                      ],
                ...
                children: <Widget>[
                  ...
                  GestureDetector(
                    onTap: () {
                      ...
                      if (state is IsLoggedIn) {
                        var userInbox =
                            Provider.of<InboxManager>(context).userInbox;

                        userInbox
                            .dispatch(InitiateChatWithCenter(widget.center.id,widget.center.name));

                        _inboxSubscription ??= userInbox.state.listen((state) {
                          if (state is ChatInitiated) {
                            Navigator.of(context).push(MaterialPageRoute(
                                builder: (context) => ChatPage(state.bloc)));
                          }
                        });
                      } else {
                        Navigator.push(
  ...
  Widget _buildService(String title) {
    return Container(
      ...
      child: Text(
        title,
        style: TextStyle(fontSize: 12, color: StaticAppColors.main_color),
      ),
    );
  }
